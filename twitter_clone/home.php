	...
	<head>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){		
				...
				// associar o evento de teclar enter
				$('#texto_tweet').keypress(function(e){
					$('#form_tweet').submit(false);
					if(e.which == 13) {
				...
				function ajaxIncluiTweet() {
					if($('#texto_tweet').val().length > 0){
						
						$.ajax({
							url: 'inclui_tweet.php',
							method: 'post',
							data: $('#form_tweet').serialize(), //para form grande com varios campos,retorna um json
