<?php
	...
	$objDb = new db(); // instancia de conexao com o banco de dados
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){		
				...
				$('#btn_procurar_pessoa').click(function(){
					...
					if($('#nome_pessoa').val().length > 0){
						...
						$.ajax({
							url: 'get_pessoas.php',
							method: 'post',
							data: $('#form_procurar_pessoas').serialize(), //para form grande com varios campos,retorna um json
							// data: { texto_tweet: $('#texto_tweet').val() }, // json - chave: valor
							success: function(data) {
								$('#pessoas').html(data);

								$('.btn_seguir').click(function(){
									var id_usuario = $(this).data('id_usuario'); // data() -> recupera o valor do atributo customizado --- data-id_usuario="" no get_pessoas.php
				...
				$('#nome_pessoa').keypress(function(e){
					$('#form_procurar_pessoas').submit(false);
					if(e.keyCode == 13) {
